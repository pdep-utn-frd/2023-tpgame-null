...
////////////////////////////// CLASE CONSTRUCCION
	...
	class Construccion inherits Polimorfismo  {
		...
		override method darMadera(cantidad){  // el parametro es  la cantidad de recurso que el jugador tiene, y pierde al usarlo en la construccion
			cantidadMadera = cantidadMadera + cantidad
			self.calcularTotal()
		}
		override method darPiedra(cantidad){
